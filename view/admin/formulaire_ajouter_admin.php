...
header('Location: ../view/page_connexion');
        }
if (isset($_SESSION['user']['mail'])){
  ?>
  ...
  <div class="container-fluid py-3">
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        <h1 class="text-center  text-dark">Inscription Administrateur</h1>
        ...
        <div class="form-row d-justify-content-center">
            <div class="form-group col-md-6 px-5 ">
                ...
                <input type="password" class="form-control" name="mots_de_passe" id="Password1" placeholder="Mots de passe" required>
            </div>

            <div class="form-group col-md-6 px-5">
                <label for="Password2">Confirmer votre mots de passe</label>
                <input type="password" class="form-control" name="mots_de_passe2" id="Password2" placeholder="Mots de passe" required>
            </div>
        </div>
        ...
        <?php require_once '../../api/personnes/ajouter_admin.php'; ?>
