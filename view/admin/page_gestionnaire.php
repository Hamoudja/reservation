  ...
  <div class="container-fluid py-3">
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        <h1 class="text-center  text-dark">Liste Gestionnaires</h1>
        
        <a href="../admin/formulaire_ajouter_gestionnaire" > Ajouter Gestionnaire? </a>

        <?php require_once '../../api/personnes/liste_gestionnaire.php'; ?>
